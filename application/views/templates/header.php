...
<head>
    ...
    <!-- jvectormap -->
    <link rel="stylesheet"
        href="<?php echo base_url(); ?>assets/admin_lte_assets/plugins/jvectormap/jquery-jvectormap-1.2.2.css">
    <!-- Date Picker -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/admin_lte_assets/plugins/datepicker/datepicker3.css">
    <!-- Daterange picker -->
    <link rel="stylesheet"
        href="<?php echo base_url(); ?>assets/admin_lte_assets/plugins/daterangepicker/daterangepicker.css">
    <!-- bootstrap wysihtml5 - text editor -->
    <link rel="stylesheet"
        href="<?php echo base_url(); ?>assets/admin_lte_assets/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
                                ...
                                <li>
                                    ...
                                    <ul class="menu">
                                        <li>
                                            ...
                                            <a href="#">
                                                <div class="pull-left">
                                                    ...
                                                    <img src="<?php echo base_url('assets/admin_lte_assets/dist/img/' . $user['avatar']); ?>"
                                                        class="img-circle" alt="User Image">
                                                    <?php else: ?>
                                                    <img src="<?php echo base_url('assets/admin_lte_assets/dist/img/default-avatar.png'); ?>"
                                                        class="img-circle" alt="User Image">
                                                    <?php endif; ?>
                                                </div>
                                                <h4>
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="<?php echo base_url(); ?>assets/admin_lte_assets/dist/img/user4-avatar.jpg"
                                                        class="img-circle" alt="User Image">
                                                </div>
                                                <h4>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    ...
                                    <p>
                                        ...
                                        <small>Member since
                                            <?php echo date('M Y', strtotime($user['created_at'])); ?></small>
                                    </p>
                                ...
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a href="<?php echo base_url('admin/profile'); ?>" id="profile-link"
